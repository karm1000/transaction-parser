...
bench get-app india_compliance --branch "$BRANCH_TO_CLONE" --resolve-deps
bench get-app transaction_parser "${GITHUB_WORKSPACE}"
...
bench --verbose install-app transaction_parser
